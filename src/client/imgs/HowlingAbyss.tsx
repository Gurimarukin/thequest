...
export const HowlingAbyss = ({ className }: Props): JSX.Element => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 91 91" className={className}>
    <g transform="translate(-5,-5)">
      ...
      <path
        ...
        stroke="none"
        d="m 15.5,59.5 44,-44 h 26 v 26 l -44,44 h -26 z"
      />
    </g>
  </svg>
)

export const HowlingAbyssSimple = ({ className }: Props): JSX.Element => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 96 96" className={className}>
    <g transform="translate(-2.5,-2.5)">
      ...
      <path
        ...
        fillOpacity={fillOpacity}
        stroke="none"
        d="m 23.5,62.5 39,-39 h 15 v 15 l -39,39 h -15 z"
      />
    </g>
  </svg>
)
